...
{
    [Header("Titre du joueur, titre suivant � chaque fois que le joueur atteint un objectif")]
    [SerializeField, Tooltip("Liste des diff�rents titre que le joueur obtient suivant sa progression.")] private string[] m_playersTitle;
